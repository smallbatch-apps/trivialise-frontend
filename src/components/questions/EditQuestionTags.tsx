...
const EditQuestionTags: FC<Props> = ({ question, tags }) => {
  ...
  const [qtags, setQtags] = useState<readonly Tag[]>(question.tags);
  ...
  return (
    <div className="flex items-center w-full my-3">
      ...
      {!editing && (
        <div className="p-2 bg-white rounded-sm border border-white hover:border-gray-300 cursor-pointer flex-grow" onClick={() => setEditing(true)}>
