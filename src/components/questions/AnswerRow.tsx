...
const AnswerRow: FC<Props> = ({ answer, currentAnswerId, setCurrentAnswerId, index }) => {
      ...
      {provided => (
        <>
          {currentAnswerId !== answer.id && (
            <tr className="border border-b-1 group" ref={provided.innerRef} {...provided.dragHandleProps} {...provided.draggableProps}>
              <td className="p-2 text-center">
                {answer.points !== 0 ? <i className="fad fa-check-circle text-green-600"></i> : <i className="fad fa-circle text-gray-300"></i>}
              </td>
              ...
              <td className="p-1 text-center">
                ...
                <i
                  ...
                  onClick={() => {
                    answerService.delete(answer.id).then(() => queryClient.invalidateQueries("questions"));
                  }}
                ></i>
              </td>
            </tr>
            ...
            <tr className="border border-b-1 group" ref={provided.innerRef} {...provided.dragHandleProps} {...provided.draggableProps}>
              <td className="p-2" colSpan={4}>
                <div className="flex w-full">
                  <input type="text" className="p-1 flex-grow" name="text" value={text} onChange={e => setText(e.target.value)} />
                  <input type="text" className="p-1 mx-3 w-16" name="text" value={points} onChange={e => setPoints(+e.target.value)} />
                  <div className="rounded-b text-right">
                    ...
                    >
                      <i className="fad fa-times text-xl relative" style={{ top: "3px" }}></i>
                    </button>
                    <button
                    ...
                    >
                      <i className="fad fa-check text-xl relative" style={{ top: "3px" }}></i>
                    </button>
                  </div>
                </div>
              </td>
